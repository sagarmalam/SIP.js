...
export class SessionDescriptionHandler {
    ...
    getDescription(options, modifiers) {
        ...
        // (_a = options === null || options === void 0 ? void 0 : options.offerOptions) === null || _a === void 0 ? void 0 : _a.iceRestart;
        ...
        return this.getLocalMediaStream(options)
            ...
            sdp = sessionDescription.sdp.replace("useinbandfec=1", "usedtx=1;useinbandfec=1; maxaveragebitrate=64000; maxplaybackrate=16000; sprop-maxcapturerate=16000; ptime=20; maxptime=40;minptime=10; stereo=0");
            return {
                body: sdp,
