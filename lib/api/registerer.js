...
export class Registerer {
    ...
    waitingToggle(waiting) {
        if (this._waiting === waiting) {
            ...
            //This patch is applied by sagar malam to not crash  but simply return in this case 
            this.logger.log(`Invalid waiting transition from ${this._waiting} to ${waiting}`);
            return;
            ///////////////////////////////////////////////////////////////////////////////////
        }
